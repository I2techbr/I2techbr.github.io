...
jQuery(document).ready(function () {
    ...
    if (jQuery('.fixed-header').length) {
        if (!jQuery('.header-section').hasClass('sidebar-header')) {
            jQuery.getScript('/lib/waypoint/jquery.waypoints.min.js', function () {
                jQuery.getScript('/lib/waypoint/sticky.min.js', function () {
                    gfortFixedHeaderfn();
                });
            });
        }
    ...
    if (jQuery('.notification-block').length) {
        ...
        jQuery.getScript('/lib/cookie/js.cookie.min.js', function () {
            gfortNBCookiefn();
        });
    }
    ...
    if (jQuery('[data-scroll]').length) {
        jQuery.getScript('/lib/scrollto/jquery.scrollTo.min.js', function () {
            gfortScrollTofn();
        });
    }
    ...
    if (jQuery('.gfort-owl-slider').length) {
        if (!jQuery('link[href="/lib/owl-carousel/assets/owl.carousel.min.css"]').length) {
            jQuery('head').prepend('<link rel="stylesheet" href="/lib/owl-carousel/assets/owl.carousel.min.css">');
            jQuery('head').prepend('<link rel="stylesheet" href="/lib/owl-carousel/assets/owl.theme.default.min.css">');
            jQuery.getScript('/lib/owl-carousel/owl.carousel.min.js', function () {
    ...
    if (jQuery('.instagram-feed-block').length) {
        jQuery.getScript('/lib/gfortinsta/gfortInsta.min.js', function () {
            gfortInstafn();
        });
    }
    ...
    function gfortTwitterfn() {
        jQuery('.twitter-feed-block').each(function (index) {
            ...
            el.twittie({
                ...
                apiPath: '/lib/tweetie/api/tweet.php',
    ...
    if (jQuery('.twitter-feed-block').length) {
        jQuery.getScript('/lib/tweetie/tweetie.min.js', function () {
    ...
    function gfortFancyBoxfn() {
        ...
        jQuery('[data-gfort-lightbox-html5]').fancybox({
            ...
            afterLoad: function () {
                ...
                jQuery.getScript('/lib/videojs/videojs.min.js', function () {
    ...
    if (jQuery('[data-gfort-lightbox]').length) {
        if (!jQuery('link[href="/lib/fancybox/jquery.fancybox.min.css"]').length) {
            jQuery('head').prepend('<link rel="stylesheet" href="/lib/fancybox/jquery.fancybox.min.css">');
            jQuery.getScript('/lib/fancybox/jquery.fancybox.pack.js', function () {
                jQuery.getScript('/lib/fancybox/helpers/jquery.fancybox-media.min.js', function () {
                    gfortFancyBoxfn();
                });
            });
        } else {
    ...
    if (jQuery('[data-gfort-lightbox-html5]').length) {
        if (!jQuery('link[href="/lib/videojs/videojs.min.css"]').length) {
            jQuery('head').prepend('<link rel="stylesheet" href="/lib/videojs/videojs.min.css">');
        }
    }
    ...
    if (jQuery('iframe').length) {
        jQuery.getScript('/lib/fitvids/jquery.fitvids.min.js', function () {
            gfortFitVidfn();
        });
    }
    ...
    if (jQuery('.background-video-block div[data-youtube-video-url]').length) {
        jQuery.getScript('/lib/gfortytplayer/ytplayer.js', function () {
            gfortYouTubeVideofn();
        });
    }
    ...
    function mapMarkersfn(currentMapIndex) {
        ...
        jQuery('#gfort-main-google-map-block-' + currentMapIndex + ' .google-map-marker').each(function (index) {
            ...
            infoWindowOptions = {
                ...
                closeBoxURL: "/lib/infobox/close.png"
            };
        ...
        jQuery('.google-map-block').each(function (index) {
            ...
            if (el.hasClass('google-map-block-collapsed')) {
                if (parallaxEffect === true) {
                    ...
                    jQuery.getScript('/lib/parallax/jquery.parallax-1.1.3.min.js', function () {
                        gfortParallaxfn();
                    });
                }
    ...
    if (jQuery('.google-map-block').length) {
        ...
        jQuery.getScript('https://maps.googleapis.com/maps/api/js?key=' + googleMapAPIKey, function () {
            jQuery.getScript('/lib/infobox/infobox_packed.js', function () {
                gfortGoogleMapfn();
            });
        });
    }
    ...
    if (jQuery('.text-animation').length) {
        jQuery.getScript('/lib/typed/typed.min.js', function () {
    ...
    if (jQuery('.prettyprint').length) {
        jQuery.getScript('/lib/prettify/prettify.min.js', function () {
            gfortPrettyPrintfn();
        });
    }
    ...
    if (jQuery('.downtime-counter-block').length) {
        jQuery.getScript('/lib/downCount/jquery.downCount.min.js', function () {
    ...
    if (jQuery('.pie-block').length) {
        ...
        jQuery.getScript('/lib/easypiechart/jquery.easypiechart.min.js', function () {
            jQuery.getScript('/lib/waypoint/jquery.waypoints.min.js', function () {
    ...
    if (jQuery('.wow').length) {
        if (enableAnimation === true) {
            jQuery.getScript('/lib/wow/wow.min.js', function () {
                gfortAnimationfn();
            });
        }
    }
    ...
    if (!isMobile.any()) {
        ...
        if (jQuery('select').length) {
            if (!jQuery('link[href="/lib/chosen/chosen.min.css"]').length) {
                jQuery('head').prepend('<link rel="stylesheet" href="/lib/chosen/chosen.min.css">');
                jQuery.getScript('/lib/chosen/chosen.jquery.min.js', function () {
                    gfortSelectfn();
                });
            } else {
                jQuery.getScript('/lib/chosen/chosen.jquery.min.js', function () {
        ...
        if (jQuery('.counter-block').length) {
            jQuery.getScript('/lib/waypoint/jquery.waypoints.min.js', function () {
                jQuery.getScript('/lib/countto/jquery.countTo.min.js', function () {
                    gfortCounterfn();
                });
            });
        }
...
jQuery(window).load(function () {
    ...
    ------------------------------------------------------------------------- */
    if (jQuery('.isotope-masonry').length) {
        jQuery.getScript('/lib/isotope/isotope.pkgd.min.js', function () {
            jQuery.getScript('/lib/isotope/packery-mode.pkgd.min.js', function () {
                gfortisotopefn();
            });
        });
    }
